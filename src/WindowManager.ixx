...
export namespace lysa {
    ...
    namespace ui {
        ...
        public:
            ...
            Vector2DRenderer& getRenderer() const { return uiRenderer; }
        ...
        public:
            WindowManager(lysa::Window& renderingWindow, Vector2DRenderer&renderer, const std::string& defaultFontName, float defaultFontScale, const float4& defaultTextColor);
